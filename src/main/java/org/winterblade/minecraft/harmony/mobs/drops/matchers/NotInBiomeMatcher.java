 ...
 */
@Component(properties = {"notInBiomes"})
@PrioritizedObject(priority = Priority.HIGH)
public class NotInBiomeMatcher extends BaseBiomeMatcher implements IMobDropMatcher {
    public NotInBiomeMatcher(String[] biomeIds) { super(biomeIds);}
